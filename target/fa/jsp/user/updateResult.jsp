...
<c:if test="${updateResult eq true}">
    <div style="position: relative">
        ...
        <a href="javascript:history.go(-1)" style="position: absolute;top:250px;left:700px; font-size:26px;font-weight:700;">返回上一页</a>
    </div>
</c:if>
<c:if test="${updateResult eq false}">
    <h5 style="margin: 200px auto 0 auto">更新失败</h5>
    <a href="javascript:history.go(-1)" style="margin: 200px auto 0 auto;font-size:26px;font-weight:700;">返回上一页</a>
</c:if>
