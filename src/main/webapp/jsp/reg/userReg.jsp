    ...
    <script type="text/javascript">
        $(function () {
            $("#userName").blur(function () {
                ...
                var unTips=$("#untips");
                $.ajax({
                    url:"${web}/checkusername.do/"+userName,
                    method:"post",
                    success:function (data) {
                        if(data.code==2000){
                            unTips.html("<span style='color:#2fe02e'>用户名可以使用</span>")
                        }else{
                            unTips.html("<span style='color:#e0383c'>用户名已经被使用</span>")
                        }
                    },
                    error:function (xhr) {
                        alert(xhr.status);
...
<!--头部搜索开始-->
<div class="header">
    <div class="logo fl"><img src="${web}/../images/logo.png"/></div>
    <div class="right">
        <ul id="links">
            <li data-index="0"></li>
...
<div class="main mt10">
    <div class="mleft fl ah">
        <!--注册开始-->
        <div class="reg_a jiacu">新用户注册</div>
        <div class="reg_b fl"><s:text name="register.title"></s:text></div>
        <div class="reg_c fl ah">
            <form action="${pageContext.request.contextPath}/regu.do" method="post">
                <table width="350" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="250" align="left" valign="middle"><input name="password" type="password"
                                                                            class="login_input" required="required"
                                                                            id="password" onblur="blurPassword()"/><span
                                id="ptips"></span></td>
                    </tr>
                    <tr>
                        <td width="100" height="40" align="right" valign="middle">昵&nbsp&nbsp&nbsp称：</td>
                        <td width="250" align="left" valign="middle"><input name="XiaoName" type="text"
                                                                            class="login_input" id="nickName"/><span
                                id="ntips"></span></td>
                    </tr>
                    <tr>
                        <td width="100" height="40" align="right" valign="middle">手机号：</td>
                        <td width="250" align="left" valign="middle"><input name="Tel" type="text"
                                                                            class="login_input"/><span
                                id="ttips"></span>
                        </td>
                    </tr>
                    <tr>
                        <td width="100" height="40" align="right" valign="middle">地&nbsp&nbsp&nbsp址：</td>
                        <td width="250" align="left" valign="middle"><input name="addr" type="text"
                                                                            class="login_input"/><span
                                id="atips"></span>
                        </td>
                    </tr>
                    <tr>
                        <td height="50" colspan="4" align="center" valign="middle">
                            <input type="submit" class="btn btnspace" name="commit"
                                   value="立即注册">
                            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" class="btn"
                                                                                               name="commit"
                                                                                               value="商家注册"
                                                                                               onclick="window.location.href = 'shopReg.jsp'">
                    </tr>
                </table>
            </form>
        </div>
